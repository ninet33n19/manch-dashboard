    ...
    <div className="flex mx-10 mt-56 mb-32">
        ...
        <div className="space-y-6 lg:space-y-8">
          <div className="space-y-1.5">
            <h1 className="text-5xl font-inter text-[#2B2D2D] leading-tight">
              <span className="block">All the financial tools you need.</span>
              <span className="block">None of the headaches.</span>
            </h1>
          </div>
      ...
      <div className="flex flex-col sm:flex-row items-end">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          ...
          <Button
            className="rounded-lg px-8 py-4 text-lg font-medium flex items-center space-x-2 h-auto"
            variant="default"
          >
