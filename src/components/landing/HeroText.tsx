...
export function HeroText() {
  return (
    <div className="mx-10 mt-56 mb-20 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-12">
      <div className="space-y-6 lg:space-y-8 max-w-[640px]">
        <div className="space-y-1.5">
          <h1 className="text-5xl font-inter text-[#2B2D2D] leading-tight">
            Dispute Resolution for the{" "}
            <HighlightedText>Digital Generation</HighlightedText>
          </h1>
        </div>

        <p className="text-base text-[#6B7280] font-inter leading-relaxed max-w-xl">
      ...
      <div className="flex items-end gap-4 whitespace-nowrap lg:self-end">
